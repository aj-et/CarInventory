...
@Component({
  ...
  styles: [`
    ...
    .modal { background: #1e293b; border-radius: 12px; width: 100%; max-width: 640px; border: 1px solid #334155; }
    ...
    input { background: #0f172a; border: 1px solid #334155; border-radius: 8px; padding: 0.65rem 0.875rem; color: #e2e8f0; font-size: 0.875rem; outline: none; transition: border-color 0.2s; }
